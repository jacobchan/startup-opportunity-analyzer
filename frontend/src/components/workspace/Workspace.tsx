...
export function Workspace({ events, report, errorMsg, runInfo, onBack, view }: Props) {
  ...
  return (
    <div className="ws-shell" style={{ position: 'relative' }}>
      <WorkspaceTopbar state={state} runInfo={runInfo} errorMsg={errorMsg} report={report} onBack={onBack} view={view} />
